...
<main>
    <div class="container">
        <div class="home-content">
            ...
            <p>Welcome to the Tennis Scoreboard application. Here you can:</p>
            <ul>
                <li>Start new matches</li>
                <li>Track ongoing matches</li>
                <li>View match history</li>
            </ul>
            <div class="home-buttons">
                <a href="${pageContext.request.contextPath}/new-match" class="button">Start New Match</a>
